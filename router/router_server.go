...
import (
	...
	"superdaemon/router/downloader"
	"superdaemon/router/middleware"
	"superdaemon/router/tokens"
	"superdaemon/server"
	"superdaemon/server/transfer"
)
...
// Deletes a server from the superdaemon daemon and dissociate its objects.
